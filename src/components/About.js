    ...
    return (
        <div className="about-container" >
          <div className="aboutMe-text">
            ...
            <br/> <br/>
            When I'm not geeking out over cloud technologies, you'll find me building cool stuff like <span>CloudNotifyOps</span> – (my latest project) or working on community platforms that help people connect and share resources. I love turning complex problems into elegant solutions, whether it's migrating legacy systems or creating real-time processing pipelines.
            My time at IBM taught me that great software is about more than just code – it's about collaboration, continuous learning, and creating solutions that actually make a difference. I'm that developer who gets equally excited about optimizing database queries and mentoring team members! 
